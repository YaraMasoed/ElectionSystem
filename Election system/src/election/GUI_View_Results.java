...
public class GUI_View_Results extends javax.swing.JFrame {

    Voter v;
    Candidate c;

    public GUI_View_Results() {
        initComponents();
    }

    public GUI_View_Results(Voter v) {
        initComponents();
        this.v = v;
        resultTable();
    ...
    public GUI_View_Results(Candidate c) {
        initComponents();
        this.c = c;
        resultTable();
    }
    ...
    public void resultTable() {
        ...
        if (v != null) {
            resultsList = v.viewResults();
        } else {
            resultsList = c.viewResults();
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/resultstitlever.png"))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(35, 35, 35)
                .addComponent(Backbtn1, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(113, 113, 113)
        ...
        results.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Election ID", "Candidate Name", "No of Votes"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_View_Results.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_View_Results().setVisible(true);
            }
        });
    }
